const theme = {
    ...
    button: {
        ...
        color: {
            ...
            gray: 'text-gray-400 hover:text-gray-600 focus:ring-gray-500 focus:text-gray-600 focus:ring-gray-50 focus:bg-gray-200',
    ...
    dropdown: {
        floating: {
            ...
            item: {
                base: 'flex items-center justify-start py-2 px-4 text-sm text-gray-700 cursor-pointer',
                icon: 'mr-2 h-4 w-4',
            },
            divider: 'my-1 h-px bg-gray-100 dark:bg-gray-600',
        },
        arrowIcon: 'mx-1 h-4 w-4',
